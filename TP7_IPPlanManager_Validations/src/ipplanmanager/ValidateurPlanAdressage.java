...
public class ValidateurPlanAdressage {
  public void verifierChevauchements(ArrayList<ResultatVLSM>
resultats) throws ChevauchementReseauException {
...
System.out.println("Validation terminée : aucun conflit critiquedétecté.");
}
}  
